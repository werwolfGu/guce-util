 ...
 */
public class ConcreteObserverTwo implements ObserverInterface {
    private SubjectInterface subject;
    private String name;

    public ConcreteObserverTwo( SubjectInterface subject ,String name){
    ...
    public void update(String msg) {
        ...
        System.out.println("具体观察者：" + name + " ; 推数据：" + msg);
